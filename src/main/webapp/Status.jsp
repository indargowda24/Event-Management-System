            ...
            <div class="table-container table-responsive">
                <table class="custom-table">
                    ...
                    <tbody>
                        ...
                        ArrayList<EventStatus> al = enq.getStatus(userId);
                        for (EventStatus es : al) {
                        %>
                        <tr>
                            <td class="image-container"><img src="<%=es.getEvent_image()%>" alt="Event Image"></td>
                            ...
                            <td>
                                <form action="regi" method="post">
                                    <input type="hidden" name="event_id" value="<%=es.getEvent_id()%>">
                                    <input type="submit" name="cancelevent" class="btn btn-danger" value="Cancel">
                                </form>
                            </td>
                            ...
                            <td><a href="Receipt.jsp?event_id=<%=es.getEvent_id()%>">Download</a></td>
                            <% } %>
                        </tr>
                        <%
                        }
